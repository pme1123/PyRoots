...
from .image_manipulation import img_split, ellipse_mask, equalize_exposure, _arrays_mean, _arrays_var, calc_exposure_correction, register_colors
...
__all__ = ['noise_removal', 'dirt_removal', 'grayscale_filter', 'color_filter', '_in_range',
		   '_percentile_filter', 'diameter_filter', 'length_width_filter', 'morphology_filter', 'hollow_filter',
	   	   ...
	   	   'img_split', 'ellipse_mask', 'equalize_exposure', '_arrays_mean', '_arrays_var', 'calc_exposure_correction', 'register_colors',
